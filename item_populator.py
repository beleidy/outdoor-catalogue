...
camping_array = [
    ...
    ("Insulation Mat", "A mat to go under your sleeping bag"
...
hiking_array = [
    ...
    ("Boots", "Insert your feet into these for a more comfortable hike"),
    ("Walking Poles",
     "Walking sticks, but not just for the elderly and infirm"),
    ("Insulating Jacket", "Down down down... this jacket will keep you warm, "
...
running_array = [
    ...
    ("Running Shorts", "No, these shorts don't run away from you, "
     "but will make you run more with more comfort"),
    ("Running Top", "Because there is only so much tanning you can do "
